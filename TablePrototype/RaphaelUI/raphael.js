...
Raphael = (function () {
    ...
    if (R.svg) {
        ...
        var getPath = {
                ...
                image: function (el) {
                    var a = el.attrs;
                    return ellipsePath(a.x+(a.width/2), a.y +(a.height/2), a.width/2);
                },
                text: function (el) {
        ...
        Element[proto].glow = function (glow) {
            if (this.type == "text") {
                return null;
            }
            glow = glow || {};
            var s = {
                width: (glow.width || 15) + (+this.attr("stroke-width") || 1),
                fill: glow.fill || false,
                opacity: glow.opacity || .5,
                offsetx: glow.offsetx || 0,
                offsety: glow.offsety || 0,
                color: glow.color || "#FFF"
            },
                c = s.width / 2,
                r = this.paper,
                out = r.set(),
    ...
    if (R.vml) {
        ...
        function ellipsePath(x, y, rx, ry) {
            ...
            return R.format("M{0},{1}m0,{2}a{3},{4},0,1,1,0,{5}a{3},{4},0,1,1,0,{6}z",x,y,-ry,rx,ry,2*ry,-2*ry); 
    ...
    // Porting getElementByPoint functionality
    ...
    Paper[proto].getElementByPoint = function (x, y) {
    	var paper = this,
    		svg = paper.canvas,
    		target = doc.elementFromPoint(x,y);
    	if (win.opera && target.tagName == "svg") {
    ...
    Paper[proto].getById = function (id) {
        var bot = this.bottom;
        while (bot) {
            if (bot.id == id) {
                return bot;
